...
INSERT INTO materiales_colores (id_material, id_color, costo_adicional) VALUES
-- Tintes con sus colores correspondientes y costos adicionales
(3, 1, 2.5000), -- Tinte Azul Marino con Azul Marino (+$2.50/kg)
(4, 2, 3.2000), -- Tinte Rojo con Rojo (+$3.20/kg)
(5, 3, 0.8000), -- Tinte Blanco con Blanco (+$0.80/kg)

-- También agregar otros colores para los tintes (precio diferencial por color)
(3, 2, 1.8000), -- Tinte Azul Marino usado para Rojo (+$1.80/kg menos eficiente)
(3, 3, 1.2000), -- Tinte Azul Marino usado para Blanco (+$1.20/kg dilución)
(4, 1, 2.1000), -- Tinte Rojo usado para Azul Marino (+$2.10/kg mezcla especial)
(4, 3, 0.5000), -- Tinte Rojo usado para Blanco (+$0.50/kg dilución mínima)

-- Hilo de costura varía por color (diferentes proveedores/calidades)
(8, 1, 0.3000), -- Hilo de Costura Azul Marino (+$0.30/unidad)
(8, 2, 0.4500), -- Hilo de Costura Rojo (+$0.45/unidad)
(8, 3, 0.1000), -- Hilo de Costura Blanco (+$0.10/unidad)
(8, 4, 0.2000); -- Hilo de Costura Negro (+$0.20/unidad)
